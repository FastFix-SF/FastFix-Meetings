...
Explicit final consent is recorded and submissions are progressing through the native ApplyPilot stack. Fifteen submissions and ten previously applied listings are now recorded with private evidence. A bounded batch remains active; previously CAPTCHA-blocked jobs are staged next. Some listings have expired, and missing factual answers/account access remain unresolved. Details and process handles stay in the private handoff.
